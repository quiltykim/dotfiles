...
;; My colors are in the sRGB column. I need to figure out the rest
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ;; name     sRGB      Gen RGB   256       16              8
  '((base03  "#262626" "#042028" "#1c1c1c" "brightblack"   "black")
    (base02  "#2e2e2e" "#0a2832" "#262626" "black"         "black")
    (base01  "#5e6263" "#465a61" "#585858" "brightgreen"   "green")
    (base00  "#909396" "#52676f" "#626262" "brightyellow"  "yellow")
    (base0   "#909396" "#708183" "#808080" "brightblue"    "blue")
    (base1   "#a6aaab" "#81908f" "#8a8a8a" "brightcyan"    "cyan")
    (base2   "#B8BBBD" "#e9e2cb" "#e4e4e4" "white"         "white")
    (base3   "#D2D8D9" "#fcf4dc" "#ffffd7" "brightwhite"   "white")
    (yellow  "#B68800" "#a57705" "#af8700" "yellow"        "yellow")
    (orange  "#E05F27" "#bd3612" "#d75f00" "brightred"     "red")
    (red     "#bd3832" "#c60007" "#d70000" "red"           "red")
    (magenta "#a8366b" "#c61b6e" "#af005f" "magenta"       "magenta")
    (violet  "#797FD4" "#5859b7" "#5f5faf" "brightmagenta" "magenta")
    (blue    "#2F7BDE" "#2075c7" "#0087ff" "blue"          "blue")
    (cyan    "#15968D" "#259185" "#00afaf" "cyan"          "cyan")
    (green   "#598249" "#728a05" "#5f8700" "green"         "green"))
    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                (header-line (,@fg-base02 ,@bg-base0 ,@fmt-revbb)) ; Pmenu
                (highlight (,@bg-base02))
                ...
                ;; smartparens
                (sp-pair-overlay-face ()) ;; No highlight on open paren
                ...
                (whitespace-indentation (,@fg-red))
                (whitespace-space (,@fg-base02))
                (whitespace-space-after-tab (,@fg-base02 ,@bg-red ,@bg-base02))
                (whitespace-space-before-tab (,@fmt-bold ,@fg-red ,@bg-base02))
                ...
                ;;ansi-term
                ;; since we can't get bg colors in ansi-term, and we
                ;; can't see black, make this bold and green (I like green)
                (term-color-black (,@fg-green ,@fmt-bold))
